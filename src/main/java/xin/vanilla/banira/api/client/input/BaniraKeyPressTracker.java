...
/**
 * 统一的按键连按判定器，同时过滤原生按住重复触发。
 */
public final class BaniraKeyPressTracker {
    ...
    public BaniraKeyPressTracker() {
        this(DEFAULT_DOUBLE_PRESS_MS, System::currentTimeMillis);
    }

    public BaniraKeyPressTracker(long doublePressMs, LongSupplier clock) {
    ...
    public void recordRelease(int keyCode, int scanCode) {
    ...
    private static final class KeyIdentity {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof KeyIdentity)) return false;
    ...
    private static final class DownIdentity {
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (!(o instanceof DownIdentity)) return false;
