...
public final class BaniraNotificationTypes {
    ...
    public static void register(@Nonnull String typeId) {
        ServerNotificationTypeRegistry.registerInternal(typeId);
    }

    public static void register(@Nonnull String typeId, EnumNotificationTypeDisplayMode clientDefaultDisplayIfAbsent) {
        ServerNotificationTypeRegistry.registerInternal(typeId, clientDefaultDisplayIfAbsent);
    }

    public static void register(@Nonnull String typeId, EnumPosition defaultPosition, EnumMoveType defaultAnimation) {
        ServerNotificationTypeRegistry.registerInternal(typeId, defaultPosition, defaultAnimation);
    }

    public static void register(@Nonnull String typeId, EnumPosition defaultPosition, EnumMoveType defaultAnimation,
                                EnumNotificationTypeDisplayMode clientDefaultDisplayIfAbsent) {
        ServerNotificationTypeRegistry.registerInternal(typeId, defaultPosition, defaultAnimation, clientDefaultDisplayIfAbsent);
    }

    public static boolean unregister(@Nonnull String typeId) {
        return ServerNotificationTypeRegistry.unregisterInternal(typeId);
    }

    @Nonnull
    public static EnumPosition defaultPosition(@Nonnull String typeId) {
        return ServerNotificationTypeRegistry.defaultPositionInternal(typeId);
    }

    @Nonnull
    public static EnumMoveType defaultAnimation(@Nonnull String typeId) {
        return ServerNotificationTypeRegistry.defaultAnimationInternal(typeId);
    }

    @Nonnull
    public static List<String> sortedSnapshot() {
        return ServerNotificationTypeRegistry.sortedSnapshotInternal();
    }
}
