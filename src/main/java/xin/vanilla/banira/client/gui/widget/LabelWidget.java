...
public class LabelWidget extends BaseWidget implements ITextWidget {
    ...
    public static void drawLimitedText(@Nonnull FontDrawArgs args) {
        ...
        if (StringUtils.isNotNullOrEmpty(text.content())) {
            ...
            net.minecraft.util.text.ITextComponent[] renderedLines =
                    new net.minecraft.util.text.ITextComponent[outputLines.size()];
            ...
            for (int i = 0; i < outputLines.size(); i++) {
                ...
                net.minecraft.util.text.ITextComponent renderedLine = preserveStyledComponent
     ...
     */
    private static net.minecraft.util.text.ITextComponent styledLine(
        ...
        net.minecraft.util.text.IFormattableTextComponent result =
                new net.minecraft.util.text.StringTextComponent("");
        net.minecraft.util.text.Style ellipsisStyle = source.getStyle();
        int suffixLength = line.length() - ellipsisIndex - ellipsis.length();
        if (position == EnumEllipsisPosition.START) {
            result.append(new net.minecraft.util.text.StringTextComponent(ellipsis).setStyle(ellipsisStyle));
    ...
    private static net.minecraft.util.text.IFormattableTextComponent sliceStyledComponent(
            net.minecraft.util.text.ITextComponent source, int start, int end) {
        net.minecraft.util.text.IFormattableTextComponent result =
                new net.minecraft.util.text.StringTextComponent("");
        int[] cursor = {0};
        source.visit((style, segment) -> {
            ...
            if (from < to) {
                result.append(new net.minecraft.util.text.StringTextComponent(
