...
public final class MessageUtils {
    ...
    public static void sendNotification(ServerPlayerEntity player, Component component, EnumPosition position, String notificationType) {
    ...
    public static void sendNotification(ServerPlayerEntity player, Component component, EnumPosition position, EnumMoveType animation, String notificationType) {
     ...
     */
    public static void sendDefaultNotification(ServerPlayerEntity player, Component component) {
        sendDefaultNotification(player, component, EnumNotificationStyle.NORMAL, EnumNotificationVanillaFallback.CHAT);
    }

    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumNotificationVanillaFallback vanillaFallback) {
        sendDefaultNotification(player, component, EnumNotificationStyle.NORMAL, vanillaFallback);
    }

    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumNotificationStyle style) {
        sendDefaultNotification(player, component, style, EnumNotificationVanillaFallback.CHAT);
    }

    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumNotificationStyle style, EnumNotificationVanillaFallback vanillaFallback) {
        String tid = NotificationTypeKeys.DEFAULT;
        sendNotification(player, component, ServerNotificationTypeRegistry.defaultPosition(tid), ServerNotificationTypeRegistry.defaultAnimation(tid), 5000L, style, vanillaFallback, tid);
    }

    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumPosition position) {
    ...
    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumPosition position, EnumMoveType animation) {
    ...
    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumPosition position, EnumMoveType animation, long durationTimeMs) {
    ...
    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumPosition position, EnumMoveType animation, long durationTimeMs, EnumNotificationStyle style) {
        sendDefaultNotification(player, component, position, animation, durationTimeMs, style, EnumNotificationVanillaFallback.CHAT);
    }

    public static void sendDefaultNotification(ServerPlayerEntity player, Component component, EnumPosition position, EnumMoveType animation, long durationTimeMs, EnumNotificationStyle style, EnumNotificationVanillaFallback vanillaFallback) {
