...
public final class ReflectionUtils {
    ...
    public static Class<?> getClass(Object value) {
        return ReflectionAccess.getClass(value);
    }

    @Nullable
    public static Class<?> getClass(String className) {
        return ReflectionAccess.getClass(className);
    }

    public static List<String> getPrivateFieldNames(Class<?> clazz, Class<?> target) {
        return ReflectionAccess.getPrivateFieldNames(clazz, target);
    }
