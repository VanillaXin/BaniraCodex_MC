...
public class Translator implements ITranslator {
        ...
        try {
            ((ResourceManagerAccessor) manager).banira$packs().forEach(pack -> {
                try {
                    ...
                    loadAllLanguages(pack, PackType.CLIENT_RESOURCES);
                    loadAllLanguages(pack, PackType.SERVER_DATA);
                } catch (Exception e) {
    ...
    private static void loadAllLanguages(PackResources pack, PackType packType) throws IOException {
