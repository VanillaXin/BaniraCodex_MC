...
/**
 * Fabric 1.19.2 的绘制句柄，公共绘制 API 不直接暴露 PoseStack。
 */
public final class FabricBaniraDrawHandle implements BaniraDrawHandle {
    private final @Nonnull PoseStack poseStack;

    public FabricBaniraDrawHandle(@Nonnull PoseStack poseStack) {
