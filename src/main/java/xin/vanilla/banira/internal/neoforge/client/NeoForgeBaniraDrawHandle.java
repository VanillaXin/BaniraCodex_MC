...
/**
 * NeoForge 1.21.1 的绘制句柄；原生绘制类型只停留在加载器适配层。
 */
public final class NeoForgeBaniraDrawHandle implements BaniraDrawHandle {
    private final @Nonnull PoseStack poseStack;

    public NeoForgeBaniraDrawHandle(@Nonnull PoseStack poseStack) {
