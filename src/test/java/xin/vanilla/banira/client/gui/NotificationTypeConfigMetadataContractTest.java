...
public class NotificationTypeConfigMetadataContractTest {
    ...
    public void screenConsumesRegisteredMetadataAndReportsSaveSuccess() throws Exception {
        ...
        assertTrue(source.contains("NotificationTypeRegistry.modDisplayNameInternal(segment)"));
        assertTrue(source.contains("NotificationTypeRegistry.tooltipInternal(typeId)"));
