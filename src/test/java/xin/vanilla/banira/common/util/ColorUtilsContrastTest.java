...
public class ColorUtilsContrastTest {
    ...
    public void postTranslationLegacyYellowBecomesReadableDarkYellow() {
        net.minecraft.network.chat.Component source =
                net.minecraft.network.chat.Component.literal("\u00A7eCountdown: 3");
    ...
    public void explicitRgbColorsUseTheSameContrastRuleOnLightAndDarkBackgrounds() {
        ...
        for (int background : TEST_BACKGROUNDS) {
            for (int color : colors) {
                net.minecraft.network.chat.Component source =
                        net.minecraft.network.chat.Component.literal("rgb").setStyle(
                                net.minecraft.network.chat.Style.EMPTY.withColor(
                                        net.minecraft.network.chat.TextColor.fromRgb(color & 0x00FFFFFF)));
    ...
    public void mixedLegacyColorsAreAdaptedPerSegmentInsteadOfUsingTheFirstColor() {
        ...
        net.minecraft.network.chat.Component readable = ColorUtils.readableVanillaComponentCopy(
                net.minecraft.network.chat.Component.literal(formatted.toString()), 0xFFFFF4C2);
    ...
    private static List<Integer> renderedSegmentColors(net.minecraft.network.chat.Component component) {
