...
public class ExternalInventoryCompatibilityContractTest {
    ...
    public void jeiBridgeAdoptsLookupHistoryAndScalesNativeIcons() throws Exception {
        ...
        assertFalse(source.contains("if (lookupHistoryController != null)"));

        String build = source("build.gradle");
        assertTrue(build.contains("jei-238222:7420583"));
        assertTrue(build.contains("modLocalRuntime \"curse.maven:jei-238222:7420583\""));
    }
